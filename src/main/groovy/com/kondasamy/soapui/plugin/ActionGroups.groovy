...
public class ActionGroups
{
    ...
    */
    ...
    /*
     * Actions applied to multiple test cases.
     * Have your action class extend AbstractSoapUIMultiAction<ModelItem> .
     */
    public static final String MULTI_ACTIONS = "SoapUIMultiActions";
    public static final String SHOW_DESKTOP_PANEL_ACTION = "ShowDesktopPanelAction";
}
/**
 * Created by Kondasamy Jayaraman
 * Contact: Kondasamy@outlook.com
